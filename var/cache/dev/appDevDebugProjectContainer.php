...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'check_parenthesis.helper' => 'getCheckParenthesis_HelperService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pyFbr0My8f', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f4U7lM-v7l', 0, '6Kc4bvbUufp29aU0sdOO51', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
     ...
     *
     * @return \AppBundle\Helpers\CheckParenthesisHelper A AppBundle\Helpers\CheckParenthesisHelper instance
     */
    protected function getCheckParenthesis_HelperService($lazyLoad = true)
    {
        return $this->services['check_parenthesis.helper'] = new \AppBundle\Helpers\CheckParenthesisHelper();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'santiagomail', 'user' => 'leadiance', 'password' => 'Lead2713', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_30c39bf07f344bea933231d6eb2c2b8b7013977258e7f7452305ba8d6a46da6f');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('hidalgosiles@gmail.com' => 'hidalgosiles'), 'resetting' => array('hidalgosiles@gmail.com' => 'hidalgosiles'))));
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'UserBundle\\Entity\\Users');
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('hidalgosiles@gmail.com');
        $a->setPassword(NULL);
        $a->setAuthMode('plain');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d589881fdb1a747c29c1601887dc2472b734fc79');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2W5Xsp-g1h', 0, '6Kc4bvbUufp29aU0sdOO51', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('591bfba2c51a70.50319865')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => 'gmail',
            'mailer_port' => 25,
            'mailer_user' => 'hidalgosiles@gmail.com',
            'mailer_password' => NULL,
            'secret' => 'd589881fdb1a747c29c1601887dc2472b734fc79',
            'locale' => 'en',
            'locales' => array(
                0 => 'en',
                1 => 'es',
            ...
            'kernel.secret' => 'd589881fdb1a747c29c1601887dc2472b734fc79',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'hidalgosiles@gmail.com',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'hidalgosiles@gmail.com' => 'hidalgosiles',
            ),
            ...
            'check_parenthesis.helper.class' => 'AppBundle\\Helpers\\CheckParenthesisHelper',
