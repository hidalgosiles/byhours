 ...
 */
class UserReputationLevelTranslation extends \Diagomail\UsersBundle\Entity\Translation\UserReputationLevelTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserReputationLevelTranslation $proxy) {
