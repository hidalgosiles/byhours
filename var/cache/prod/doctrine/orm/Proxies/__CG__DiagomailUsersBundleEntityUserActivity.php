 ...
 */
class UserActivity extends \Diagomail\UsersBundle\Entity\UserActivity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'id', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'datetime', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'link', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'route', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'method', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'params', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'paramsPost', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'ip', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\UserActivity' . "\0" . 'user'];
        }
    ...
    public function setParamsPost($paramsPost)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setParamsPost', [$paramsPost]);

        return parent::setParamsPost($paramsPost);
    }
    ...
    public function getParamsPost()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getParamsPost', []);

        return parent::getParamsPost();
    }
