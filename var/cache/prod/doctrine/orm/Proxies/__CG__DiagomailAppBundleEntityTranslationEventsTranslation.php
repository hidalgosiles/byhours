 ...
 */
class EventsTranslation extends \Diagomail\AppBundle\Entity\Translation\EventsTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventsTranslation $proxy) {
