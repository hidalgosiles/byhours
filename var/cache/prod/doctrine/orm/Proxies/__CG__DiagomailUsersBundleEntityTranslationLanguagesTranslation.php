 ...
 */
class LanguagesTranslation extends \Diagomail\UsersBundle\Entity\Translation\LanguagesTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LanguagesTranslation $proxy) {
