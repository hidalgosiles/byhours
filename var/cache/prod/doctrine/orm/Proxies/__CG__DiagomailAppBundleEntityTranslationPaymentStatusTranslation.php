 ...
 */
class PaymentStatusTranslation extends \Diagomail\AppBundle\Entity\Translation\PaymentStatusTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PaymentStatusTranslation $proxy) {
