...
namespace Proxies\__CG__\Diagomail\AppBundle\Entity\Translation;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class BlacklistReasonTranslation extends \Diagomail\AppBundle\Entity\Translation\BlacklistReasonTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BlacklistReasonTranslation $proxy) {
