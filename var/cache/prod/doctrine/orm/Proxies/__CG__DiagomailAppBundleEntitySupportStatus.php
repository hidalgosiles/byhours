 ...
 */
class SupportStatus extends \Diagomail\AppBundle\Entity\SupportStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportStatus' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportStatus' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportStatus' . "\0" . 'supportThread'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SupportStatus $proxy) {
