 ...
 */
class TimezoneTranslation extends \Diagomail\UsersBundle\Entity\Translation\TimezoneTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TimezoneTranslation $proxy) {
