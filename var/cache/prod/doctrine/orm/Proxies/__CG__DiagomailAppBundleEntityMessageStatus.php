 ...
 */
class MessageStatus extends \Diagomail\AppBundle\Entity\MessageStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\MessageStatus' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\MessageStatus' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\MessageStatus' . "\0" . 'description', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\MessageStatus' . "\0" . 'messageLog'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MessageStatus $proxy) {
