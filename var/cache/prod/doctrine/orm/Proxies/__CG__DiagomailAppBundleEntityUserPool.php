 ...
 */
class UserPool extends \Diagomail\AppBundle\Entity\UserPool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\UserPool' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\UserPool' . "\0" . 'creationDate', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\UserPool' . "\0" . 'user', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\UserPool' . "\0" . 'pool'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UserPool $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPool(\Diagomail\AppBundle\Entity\Pool $pool = NULL)
    {
