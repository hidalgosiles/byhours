 ...
 */
class SmsLog extends \Diagomail\UsersBundle\Entity\SmsLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'id', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'number', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'subject', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'message', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'code', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'user', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'creationDate', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'idsent', '' . "\0" . 'Diagomail\\UsersBundle\\Entity\\SmsLog' . "\0" . 'httpcode'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SmsLog $proxy) {
    ...
    public function setIdsent($idsent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdsent', [$idsent]);

        return parent::setIdsent($idsent);
    }
    ...
    public function getIdsent()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdsent', []);

        return parent::getIdsent();
    }
    ...
    public function setHttpcode($httpcode)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHttpcode', [$httpcode]);

        return parent::setHttpcode($httpcode);
    }
    ...
    public function getHttpcode()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHttpcode', []);
