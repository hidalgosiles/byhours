 ...
 */
class IpPool extends \Diagomail\AppBundle\Entity\IpPool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\IpPool' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\IpPool' . "\0" . 'ip', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\IpPool' . "\0" . 'pool'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (IpPool $proxy) {
