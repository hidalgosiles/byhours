 ...
 */
class SupportThread extends \Diagomail\AppBundle\Entity\SupportThread implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportThread' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportThread' . "\0" . 'subject', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportThread' . "\0" . 'creationDate', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportThread' . "\0" . 'user', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportThread' . "\0" . 'supportStatus', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\SupportThread' . "\0" . 'supportMessage'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SupportThread $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setSupportStatus(\Diagomail\AppBundle\Entity\SupportStatus $supportStatus = NULL)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSupportStatus', [$supportStatus]);

        return parent::setSupportStatus($supportStatus);
    }
    ...
    public function getSupportStatus()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSupportStatus', []);

        return parent::getSupportStatus();
    }
