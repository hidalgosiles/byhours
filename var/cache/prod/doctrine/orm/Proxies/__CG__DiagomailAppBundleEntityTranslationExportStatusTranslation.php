 ...
 */
class ExportStatusTranslation extends \Diagomail\AppBundle\Entity\Translation\ExportStatusTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExportStatusTranslation $proxy) {
