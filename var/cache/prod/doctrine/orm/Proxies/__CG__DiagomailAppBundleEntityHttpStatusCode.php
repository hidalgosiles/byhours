 ...
 */
class HttpStatusCode extends \Diagomail\AppBundle\Entity\HttpStatusCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\HttpStatusCode' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\HttpStatusCode' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\HttpStatusCode' . "\0" . 'description', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\HttpStatusCode' . "\0" . 'webhookEventLog'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HttpStatusCode $proxy) {
