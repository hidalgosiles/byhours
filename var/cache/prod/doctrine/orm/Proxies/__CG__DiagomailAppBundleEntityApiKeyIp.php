 ...
 */
class ApiKeyIp extends \Diagomail\AppBundle\Entity\ApiKeyIp implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiKeyIp' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiKeyIp' . "\0" . 'ip', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiKeyIp' . "\0" . 'apiKey'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ApiKeyIp $proxy) {
