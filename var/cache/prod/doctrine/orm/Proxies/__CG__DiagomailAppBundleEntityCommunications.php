 ...
 */
class Communications extends \Diagomail\AppBundle\Entity\Communications implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Communications' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Communications' . "\0" . 'user', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Communications' . "\0" . 'message', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Communications' . "\0" . 'creationDate', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Communications' . "\0" . 'modificationDate', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Communications' . "\0" . 'viewed'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Communications $proxy) {
