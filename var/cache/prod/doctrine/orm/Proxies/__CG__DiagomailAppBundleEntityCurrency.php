 ...
 */
class Currency extends \Diagomail\AppBundle\Entity\Currency implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Currency' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Currency' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Currency' . "\0" . 'symbol', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Currency' . "\0" . 'invoice'];
        }
