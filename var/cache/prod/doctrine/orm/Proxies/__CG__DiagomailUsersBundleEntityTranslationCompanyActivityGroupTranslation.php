...
namespace Proxies\__CG__\Diagomail\UsersBundle\Entity\Translation;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class CompanyActivityGroupTranslation extends \Diagomail\UsersBundle\Entity\Translation\CompanyActivityGroupTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompanyActivityGroupTranslation $proxy) {
