 ...
 */
class ExportType extends \Diagomail\AppBundle\Entity\ExportType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportType' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportType' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportType' . "\0" . 'export', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportType' . "\0" . 'translations'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExportType $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTranslation(\Diagomail\AppBundle\Entity\Translation\ExportTypeTranslation $translation)
    {
     ...
     * {@inheritDoc}
     */
    public function removeTranslation(\Diagomail\AppBundle\Entity\Translation\ExportTypeTranslation $translation)
    {
