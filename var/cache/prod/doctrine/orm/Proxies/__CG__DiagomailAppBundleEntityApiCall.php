 ...
 */
class ApiCall extends \Diagomail\AppBundle\Entity\ApiCall implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiCall' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiCall' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiCall' . "\0" . 'path', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ApiCall' . "\0" . 'apiKeyCall'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ApiCall $proxy) {
