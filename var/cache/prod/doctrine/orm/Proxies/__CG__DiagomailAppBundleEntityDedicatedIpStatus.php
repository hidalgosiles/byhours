 ...
 */
class DedicatedIpStatus extends \Diagomail\AppBundle\Entity\DedicatedIpStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\DedicatedIpStatus' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\DedicatedIpStatus' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\DedicatedIpStatus' . "\0" . 'dedicatedIp'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DedicatedIpStatus $proxy) {
