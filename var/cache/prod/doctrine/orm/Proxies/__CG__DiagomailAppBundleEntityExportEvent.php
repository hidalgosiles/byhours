 ...
 */
class ExportEvent extends \Diagomail\AppBundle\Entity\ExportEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportEvent' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportEvent' . "\0" . 'creationDate', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportEvent' . "\0" . 'event', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\ExportEvent' . "\0" . 'export'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ExportEvent $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setExport(\Diagomail\AppBundle\Entity\Export $export = NULL)
    {
