 ...
 */
class Pool extends \Diagomail\AppBundle\Entity\Pool implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Pool' . "\0" . 'id', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Pool' . "\0" . 'name', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Pool' . "\0" . 'ipPool', '' . "\0" . 'Diagomail\\AppBundle\\Entity\\Pool' . "\0" . 'userPool'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pool $proxy) {
